  ...
  <div class="container">
    <div class="content-container">
      <div class="text-container">
        ...
        <h2 :style="isDarkMode ? {backgroundColor: 'white'} : undefined">
          Designing search for mobile apps
        </h2>
        <p :style="isDarkMode ? {backgroundColor: 'white'} : undefined" class="date">
          Aug 26th, 2021, 4pm
        </p>
        <p :style="isDarkMode ? {backgroundColor: 'white'} : undefined" class="snippet">
